...
using StartBar.Interop.Native;

namespace StartBar.Interop
{
    public class WindowBlur
    {
        ...
        private static void OnIsEnabledChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is Window window)
            {
                ...
                {
                    GetWindowBlur(window)?.Detach(window);
        ...
        private static void OnWindowBlurChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is Window window)
            {
                (e.OldValue as WindowBlur)?.Detach(window);
        ...
        private static void EnableBlur(Window window)
        {
            ...
            var accent = new AccentPolicy
            {
                ...
                GradientColor = 255 << 0 | 255 << 8 | 255 << 16 | 32 << 0
            };
        ...
        private static void DisableBlur(Window window)
        {
            var windowHelper = new WindowInteropHelper(window);
